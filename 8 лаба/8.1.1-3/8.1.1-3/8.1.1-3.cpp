...
#define MAX_VERTICES 500 // Максимальное количество вершин
...
int main() {
    ...
    int numVertices = 500; // Задайте желаемое количество вершин
    int numEdges = 1550;    // Задайте желаемое количество ребер
    ...
    printf("vrema obxod v wiriny matrici cmeznocti : % f s.\n", time_spent1);
    return 0;
}
//#define _CRT_SECURE_NO_WARNINGS
//
...
//    clock_t end = clock();
//    double time_spent1 = (double)(end - start) / CLOCKS_PER_SEC;
//    printf("time obxod v wiriny cpicka cmeznocti : % f s.\n", time_spent1);
//    return 0;
//}
